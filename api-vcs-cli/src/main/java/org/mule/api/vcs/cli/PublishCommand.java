...
@Command(description = "Publish to exchange",
        name = "publish", mixinStandardHelpOptions = true, version = "checksum 0.1")
public class PublishCommand extends BaseAuthorizedCommand implements Callable<Integer> {
    ...
    public Integer call() throws Exception {
        ...
        final ValueResult master = apiVCSClient.publish(getAccessTokenProvider(), mergingStrategy, new MergeListenerLogger() {
            @Override
